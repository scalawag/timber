...
class ContextContainsConditionTestSuite extends FunSuite with ShouldMatchers {
  private val k0 = "k0"
  private val k1 = "k1"
  private val v0 = "v0"
  private val v1 = "v1"
  private val v2 = "v2"
  private val c = new ContextContainsCondition("k1", "v1")
  ...
  test("allow when right key contains value further down in the stack") {
    c.allows(entry(Map("k1" -> Stack("v0", "v1")))) should be (Some(true))
  }
