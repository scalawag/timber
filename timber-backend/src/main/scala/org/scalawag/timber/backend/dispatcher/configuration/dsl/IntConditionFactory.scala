...
class IntConditionFactory(override val extractionLabel:String, override val extractFrom:EntryFacets => Option[Iterable[Int]])
  extends ConditionFactory[Int](extractionLabel,extractFrom)
{
  ...
  case class IntGreaterThanOrEqualCondition private[dsl] (val operation:String,val threshold:Int) extends IntCondition {
