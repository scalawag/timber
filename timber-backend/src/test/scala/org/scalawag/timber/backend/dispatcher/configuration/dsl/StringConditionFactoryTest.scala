...
class StringConditionFactoryTest extends FunSpec with Matchers with MockFactory {
  ...
  private def declareTest(description:String, condition: Condition, extraction:Option[Iterable[String]], expected:Option[Boolean]) {
